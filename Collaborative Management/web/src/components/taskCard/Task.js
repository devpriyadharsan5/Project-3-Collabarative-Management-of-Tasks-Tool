  ...
  return (
    <div className="cardMain">
      ...
      <p className="cardText">{
        tags?.map((elem, index)=>{
          return (
            <span className="badge text-bg-primary mx-1 my-1">{elem}</span>
          )
        })
      }</p>
      <p className="cardText">{
        links?.map((elem, index)=>{
          return (
            <span className="badge text-bg-light mx-1 my-1"><a href={elem} target="_blank">{elem}</a></span>
          )
        })
      }</p>
      <p className="cardText ms-1">{
       ...
       <p className="cardText">{
        assignedTo?.map((elem, index)=>{
          return (
            <span className="badge text-bg-success mx-1 my-1">{elem}</span>
          )
        })
      }</p>
      <p className="cardText">{
